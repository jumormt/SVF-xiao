...
public:
    ...
    static inline bool classof(const ConstantDataValVar* val) {
        return val->getNodeKind() == BlackHoleNode;
    }
    static inline bool classof(const ValVar* node)
    {
...
public:
    ...
    {
        return node->getNodeKind() == ConstantFPObjNode;
    }
    static inline bool classof(const SVFVar* node)
    {
...
public:
    ...
    static inline bool classof(const ConstantDataObjVar* node) {
        return node->getNodeKind() == ConstantIntObjNode;
    }
    static inline bool classof(const SVFVar* node)
    {
...
public:
    ...
    static inline bool classof(const ConstantDataObjVar* node) {
        return node->getNodeKind() == ConstantNullptrObjNode;
    }
    static inline bool classof(const SVFVar* node)
    {
