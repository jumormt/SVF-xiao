...
- [x] **Step 1: Demo script** `svf-llvm/tools/Harness/demo/llm_workflow.sh`: builds
...
- [x] **Step 2: Wire tests into the build** — add to `svf-llvm/tools/Harness/CMakeLists.txt`:
...
- [x] **Step 3: Run FULL existing Test-Suite serially** — 2267/2267 (2266 baseline + harness_integration) — verified 2026-06-10.
- [x] **Step 4: Docs** — `svf-llvm/tools/Harness/README.md` (protocol spec, method
...
- [x] **Step 5: Commit + push** — `harness: e2e demo, ctest integration, docs`

## Verification (plan-level)

- [x] `python3 .../run_tests.py -v` all green via fresh build
- [x] `ctest -R harness_integration` green; full Test-Suite still 2266/2266 (serial)
- [x] `demo/llm_workflow.sh` exits 0 with a malloc→use witness path
- [x] MCP smoke test green (or cleanly skipped where `mcp` not installed)
- [x] Upstream-merge friendliness: all new code confined to `svf-llvm/tools/Harness/`,
